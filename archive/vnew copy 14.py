...
<style>
    ...
    .stButton>button {
        ...
        box-shadow: 0 2px 4px rgba(0, 0, 209, 0.2) !important;
    }
    
    .stButton>button:hover {
        background-color: #0000a8 !important;
        color: white !important;
        box-shadow: 0 4px 8px rgba(0, 0, 209, 0.3) !important;
    ...
    /* Tab styling - Beautiful bubble tabs */
    ...
    .stTabs [aria-selected="true"] {
        ...
        box-shadow: 0 4px 12px rgba(0, 0, 209, 0.3) !important;
    }
    ...
    .stTextArea>div>div>textarea:focus {
        border-color: #0000D1 !important;
        box-shadow: 0 0 0 3px rgba(0, 0, 209, 0.1) !important;
    }
    ...
    .stFileUploader>div>div {
        border-radius: 8px !important;
        border: 2px dashed #0000D1 !important;
